...
@NgModule({
  declarations: [AdminComponent, HeaderForAdminComponent, ManageAccountComponent, ManageCandidateComponent, CandidateDetailComponent, ManageEmployerComponent, EmployerDetailComponent, ManageJobPostComponent, JobpostDetailComponent
    ,ToastComponent, ManageJoblocationComponent, ManageJobtypeComponent, CreateJobtypeComponent, UpdateJobtypeComponent
  ],
  imports: [
    CommonModule,
